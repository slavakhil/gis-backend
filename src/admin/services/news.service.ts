...
export const beforeEditNews: Before = async (request: ActionRequest, context: ActionContext) => {
  const dateField = 'date'; // замените на имя вашего поля
...
export const afterEditNews: After<RecordActionResponse> = async (response, request, context: ActionContext) => {
